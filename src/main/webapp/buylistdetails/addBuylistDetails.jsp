	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<table id="table-1">
				<tr>
					<td>
						<h3>訂單商品細項新增 - addBuylistDetails.jsp</h3>
					</td>
					<td>
						<h4>
			...
			<FORM METHOD="post" ACTION="buylistdetails.do" name="form1"
				...
				<table>
					...
					<tr>
						<td>訂單編號ID:</td>
						<td><input type="TEXT" name="buylist" size="45" required /></td>
					</tr>
					<tr>
						<td>商品ID:</td>
						<td><input type="TEXT" name="comm" size="45" required /></td>
					</tr>
					<tr>
						<td>訂單商品細項價格:</td>
						<td><input type="TEXT" name="buylistDetailsPrice" size="45"
							required /></td>
					</tr>
					<tr>
						<td>訂單商品細項購買量:</td>
