...
<title>訂單細項資料修改 - update_buylistDetails_input.jsp</title>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<table id="table-1">
				<tr>
					<td>
						<h3>訂單商品細項資料修改</h3>
						<h4>
							<a href="listAllBuylistDetails.jsp"> <img
								src="images/back1.gif" width="100" height="32" border="0">回訂單細項首頁
							</a>
						</h4>
					</td>
				</tr>
			...
			<FORM METHOD="post" ACTION="buylistdetails.do" name="form1"
				...
				<table>
					<tr>
						<td>訂單商品細項ID:<font color=red><b>*</b></font></td>
