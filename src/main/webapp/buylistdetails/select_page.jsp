...
<body class="hold-transition sidebar-mini layout-fixed">
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<ul>
				<li><a href='listAllBuylistDetails.jsp'>List</a> all
					buylistDetailss. <br>
				<br></li>
				...
				<jsp:useBean id="buylistDetailsSvc" scope="page"
					...
					<FORM METHOD="post" ACTION="buylistdetails.do">
						<b>選擇訂單商品細項編號:</b> <select size="1" name="buylistDetailsId">
							<c:forEach var="buylistDetails"
								items="${buylistDetailsSvc.getAllBuylistDetailss()}">
			...
			<ul>
				<li><a href='addBuylistDetails.jsp'>Add</a> a new
					buylistDetails.</li>
			</ul>
