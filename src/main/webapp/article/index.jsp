...
<body>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="main_banner_text_wrapper">
                        <h1>最新<span>熱門</span>文章</h1>
                        <br> </br>
                        <h2>想要擁有自己的毛小孩又不想花大錢嗎?
                            那快來我們領養專區看看!!
                        </h2>
                        <a href="about.html" class="btn btn_theme btn_md">可愛的毛小孩專區</a>
    ...
    <div class="col-lg-12">
                ...
                <div class="blog_area_wrapper">
                    ...
                    <div class="blog_area_content">
                        <h3><a href="blog-details.html">Top cat foods to consider if you are a
                                first time owner</a></h3>
                        <p>
                            Irure enim eiusmod ipsum do Lorem sit consectetur enim consectetur. Nostrud ipsum
                        ...
                        <div class="blog_area_author_wrappe">
                            ...
                            <div class="blog_area_author_text">
                                ...
                                <p><span>26 Oct 2021</span> <i class="fas fa-circle"></i> <span>8 min read</span> </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section id="about_area" class="section_padding_bottom">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="about_area_left_wrapper">
                                <div class="about_left_content_top">
                                    <h2>可愛的毛小孩等你帶回家
                                    </h2>
                                    <p>
                                        Nostrud labore deserunt labore culpa cillum labore ex commodo aute elit dolor
                                        pariatur.
                                        Fugiat duis exercitation ut ea duis dolore. Velit ut veniam aliquip aute dolor
                                        aliqua
                                        aute consectetur.
                                    </p>
                                ...
                                <div class="about_left_content_bottom">
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapseOne" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body">
                                                    <p>
                                                        Nostrud labore deserunt labore culpa cillum labore ex commodo
                                                        aute elit
                                                        dolor pariatur. Fugiat duis exercitation ut ea duis dolore.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
        ...
        <!-- Testimonial Area -->
        <section id="testimonial_area" class="section_padding_bottom slider_side_btn">
            <div class="container">
                <!-- Section Heading -->
                <div class="row">
                    <div class="col-lg-6 offset-lg-3">
