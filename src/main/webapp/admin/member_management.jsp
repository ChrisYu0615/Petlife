											...
											<div class="modal-dialog modal-dialog-centered">
												<div class="modal-content">
													...
													<div class="row modal-footer">
														...
														<input type="hidden" name="action" value="modifyUserAcctState">
														<input type="hidden" name="modify" value="suspendUser">
														<div class="col"></div>
													</div>
												</div>
											</div>
											...
											<div class="modal-dialog modal-dialog-centered">
												<div class="modal-content">
													...
													<div class="row modal-footer">
														...
														<input type="hidden" name="action" value="modifyUserAcctState">
														<input type="hidden" name="modify" value="recoverUser">
														<div class="col"></div>
													</div>
												</div>
											</div>
