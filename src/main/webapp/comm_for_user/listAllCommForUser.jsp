			...
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="sidebar_boxed_wrapper">
						...
						<!-- search bar -->
						<form
							action="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do"
							method="post">
							<div class="input-group mb-3">
								<input type="text" class="form-control" name="searchQuery"
									placeholder="Search"> <input type="submit" value="搜尋名稱"
									...
									<div class="accordion-body">
										<ul class="list-group list-group-flush">
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=1000">貓咪飼料</a>
											</li>
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=1001">貓咪主食罐</a>
											</li>
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=1002">貓咪副食罐</a>
											</li>
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=1003">貓咪零食</a>
											</li>
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=1004">貓咪用品</a>
											</li>
										</ul>
									</div>
								</div>
							...
							<div class="accordion-item">
								...
								<div id="collapseTwo" class="accordion-collapse collapse"
									...
									<div class="accordion-body">
										<ul class="list-group list-group-flush">
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=2000">狗狗飼料</a>
											</li>
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=2001">狗狗主食罐</a>
											</li>
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=2002">狗狗副食罐</a>
											</li>
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=2003">狗狗零食</a>
											</li>
											<li class="list-group-item"><a
												href="<%=request.getContextPath()%>/comm_for_user/listAllCommForUser.do?action=2004">狗狗用品</a>
											</li>
										</ul>
									</div>
								</div>
									...
									<div class="col-lg-4 col-md-6 col-sm-12 col-12">
										<div class="shop_main_item">
											...
											<div class="shop_item_content">
												<h3>
													<a
														href="<%=request.getContextPath()%>/comm_for_user/singleCommForUser.do?action=show_comm_without_customer&commId=${comm.commId}">${comm.commName}</a>
												</h3>
												...
												<FORM METHOD="post"
													...
													<input type="submit" value="加入購物車"> <input
														type="hidden" name="action" value="add_comm_to_cart">
