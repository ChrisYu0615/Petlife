        ...
        <div class="adoption_booking_content">
            ...
            <div class="user_res_infos">
                ...
                <div class="data_wrap">
                    ...
                    <div><span class="data-title">收容編號：</span><span class="data-content">${reservation.petId}</span></div>
                    <div><span class="data-title">預約日期：</span><span class="data-content">${reservation.shelterBooking.shelterBookingDate}</span></div>
                    <div><span class="data-title">預約時間：</span><span class="data-content">${reservation.shelterBooking.shelterBookingTime}</span></div>
                </div>
            </div>
            <br>
