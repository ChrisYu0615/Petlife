...
<%-- 	</c:if> --%>
	...
	<div>
		...
		<form action="<%=request.getContextPath()%>/shelter/shelter.do" method="post" enctype="multipart/form-data">			
			...
			<input id ="shelterAcct" name="shelterAcct" type="text" value="${shelter.shelterAcct}" /><br>
			<label for="shelterPwd">收容所密碼:</label>
			<input id ="shelterPwd" name="shelterPwd" type="text" value="${shelter.shelterPwd}" /><br>
			<label for="shelterName">收容所名稱:</label>
			<input id ="shelterName" name="shelterName" type="text" value="${shelter.shelterName}" /><br>
			<label for="shelterPhoneNum">收容所電話號碼:</label>
			<input id ="shelterPhoneNum" name="shelterPhoneNum" type="text" value="${shelter.shelterPhoneNum}" /><br>
			<label for="shelterAddress">收容所地址:</label>
			<input id ="shelterAddress" name="shelterAddress" type="text" value="${shelter.shelterAddress}" /><br>
...
<%-- 			<input id ="shelterPhoto" name="shelterPhoto" type="text" value="${param.shelterPhoto}" /><br> --%>
			...
			<input id ="shelterIntroduction" name="shelterIntroduction" type="text" value="${shelter.shelterIntroduction}" /><br>
			<label for="shelterLng">收容所位置(經度):</label>
			<input id ="shelterLng" name="shelterLng" type="text" value="${shelter.shelterLng}" /><br>
			<label for="shelterLat">收容所位置(緯度):</label>
			<input id ="shelterLat" name="shelterLat" type="text" value="${shelter.shelterLat}" /><br>
			</div>
