...
// BuylistDetails buylistDetails = (BuylistDetails) request.getAttribute("buylistDetailsList"); //EmpServlet.java(Concroller), 存入req的empVO物件
%>
<!DOCTYPE html>
<html lang="zh-TW">
					...
					<td>
						...
						<h4>
							<a href="listAllBuylist.jsp"> <!-- 							<img src="images/back1.gif" -->
								<!-- 								width="100" height="32" border="0"> --> 回訂單首頁
							</a>
						</h4>
					</td>
				</tr>
...
<!-- 					<th>刪除</th> -->
				...
				<c:forEach var="buylistDetails" items="${buylistDetailsList}">
				<tr>
