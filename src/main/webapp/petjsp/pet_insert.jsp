...
<%  
	Pet pet = new Pet();
	Object petObject = request.getAttribute("pet");
	try{
		if(petObject!=null){
			pet = (Pet)petObject;
	    }
		...
		System.out.println("pet_insert.jsp: GetPet Fail");
		e.getStackTrace();
	}
...
<body class="hold-transition sidebar-mini layout-fixed">
		...
		<div class="container-fluid">
			...
			<div class="col-lg-6">
				...
				<form  class="from" enctype="multipart/form-data" id="pet_form">
					...
					<!--   收容所到時后關起來,種類打開  -->
					<div class="con">
						<label>收容所:</label> <span>${pet.sheltername.shelterName} </span>
					</div>
					...
					<div class="con">
						<label>是否開放領養:</label> <span><%=(pet.getAdopt())?"是":"否" %></span>
					...
					<div class="con">
						<label>是否被領養:
						</label><span><%=(pet.getAdopted())?"是":"否" %></span>
					...
					<div class="con">
						<label for="adoped_date">領養日期:</label> <span>${pet.adoptDate}
						</span>
					</div>
			</div>
	...
	<script>
              ...
              function back_pages() {
                  ...
                  window.location.href = 'pet_search.jsp';
              }
