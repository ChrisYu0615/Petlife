...
//    private Date sellerPwdEditTime; //DATE型別?
    ...
    @ManyToOne
    @JoinColumn(name = "acct_state_id" ,referencedColumnName = "acct_state_id")
    ...
    @ManyToOne
    @JoinColumn(name = "acct_type_id",updatable = false,columnDefinition = "TINYINT")
    ...
    @Column(name = "seller_create_time")
    private Timestamp sellerCreateTime; 

    @Column(name = "seller_pwd_err_times",columnDefinition = "TINYINT")
	...
	public Seller(int sellerId, String sellerAcct, String sellerPwd,  String sellerName,
			...
			Timestamp sellerCreateTime, Integer sellerPwdErrTimes) {
		super();
...
//    //要記得改回來
	...
	public String toString() {
		return "Seller [sellerId=" + sellerId + ", sellerAcct=" + sellerAcct + ", sellerPwd=" + sellerPwd
				...
				+ acctType + ", swiftCode=" + swiftCode + ", bankAcct=" + bankAcct + ", idFront="
				+ Arrays.toString(idFront) + ", idBack=" + Arrays.toString(idBack) + ", bankAcctImg="
				+ Arrays.toString(bankAcctImg) + ", sellerCreateTime=" + sellerCreateTime + ", sellerPwdErrTimes="
				+ sellerPwdErrTimes + "]";
	}
}
